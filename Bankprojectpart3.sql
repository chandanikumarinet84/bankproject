CREATE OR REPLACE PACKAGE BANK_PROJECT IS
...
PROCEDURE DEL_CUST(P_CUST_ID BANK_CUST.CUST_ID%TYPE);

PROCEDURE DEL_CUST(P_CUST_FIRST_NAME BANK_CUST.CUST_FIRST_NAME%TYPE);
